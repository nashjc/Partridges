...
On a single day, the number of presents $S(n)$ is clearly the sum of an arithmetic progression \@ref(eq:arithmetic).
\begin{equation}
S(k) = \sum_{i=1}^k i
\tag{Arith-progrn}
\label{eq:arithmetic}
...
Table: (\#tab:total) Total gifts received as of each of the 12 days.
